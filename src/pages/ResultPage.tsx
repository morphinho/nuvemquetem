...
const ResultPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Get user data from funnel storage or location state
    const funnelData = getFunnelData();
    const storedUserData = funnelData?.userData || location.state?.userData;
